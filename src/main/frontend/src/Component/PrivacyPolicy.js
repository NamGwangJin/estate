...
export default function PrivacyPolicy({onClose}) {
  return (
        ...
        [개인정보처리방침]<br />
		1 개인정보의 처리 목적<br />
		"루루공인중개사사무소"은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.<br />
		- 맞춤 매물 제공<br />
		...
		① "루루공인중개사사무소"은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 또는 법령에 따른 개인정보 보유․이용기간 내에서 개인정보를 처리․보유합니다.<br />
		...
		① 정보주체는 "루루공인중개사사무소"에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.<br />
		1. 개인정보 열람요구<br />
        ...
        <br />
		4 처리하는 개인정보의 항목<br />
		① "루루공인중개사사무소"은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br />
		- 필수항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 이름, 서비스 이용 기록, 쿠키, 접속 IP 정보, 결제기록<br />
        <br />
		5 개인정보의 파기<br />
		"루루공인중개사사무소"은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.<br />
        <br />
		- 파기절차<br />
		...
		① "루루공인중개사사무소"은(는) 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠기(cookie)’를 사용합니다.<br />
        ...
        <br />
		7 개인정보 보호책임자 작성<br />
		① "루루공인중개사사무소"은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br />
		▶ 개인정보 보호책임자<br />
		성명 : <br />
		연락처 : 대표번호 010-1234-5678, 대표이메일 email@naver.com<br />
		② 정보주체께서는 "루루공인중개사사무소"의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. "루루공인중개사사무소"은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br />
        <br />
		8 개인정보 처리방침 변경<br />
		①이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.<br />
        <br />
		9 개인정보의 안전성 확보 조치<br />
		"루루공인중개사사무소"은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.<br />
        <br />
		1. 정기적인 자체 감사 실시<br />
		...
		"루루공인중개사사무소"은(는) 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신•점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.<br />
        <br />
		5. 개인정보의 암호화<br />
